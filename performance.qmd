...
![The devtools package development workflow. [Source: Wickham & Brian 2023](https://r-pkgs.org/other-markdown.html)](https://r-pkgs.org/diagrams/workflow.png){width="60%"}
...
<details>
 <summary>Packages that help you check the performance of your package</summary>
...
<details>
 <summary>How to increase the speed of your package</summary>
...
_"Future is an abstraction for a value that may be availabe at some point in the future."_ [(Bengtsson 2024)](https://github.com/futureverse/future)
