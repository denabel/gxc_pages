...
menus <- list(
  list(
    id = "ext", type = "dropdown", active = 0, x = 0.125, y = 1.12,
    buttons = list(
  ...
  list(
    id = "time", type = "dropdown", active = 0, x = 0.375, y = 1.12,
    buttons = list(
  ...
  list(
    id = "cs", type = "dropdown", active = 0, x = 0.625, y = 1.12,
    buttons = list(
  ...
  list(
    id = "workers", type = "dropdown", active = 0, x = 0.875, y = 1.12,
    buttons = list(
