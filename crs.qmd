...
**Transformations** mean a change of coordinates from one CRS to another with different datum but based on a set of points common in both CRS. 
...
CRS information can be represented and transformed in PROJ an open-source library storing. GDAL can help in translating between various geospatial formats, editing and manipulating vector and raster files. Also, repojection with GDAL is possible. 
