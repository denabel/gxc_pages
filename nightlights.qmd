...
grViz("
digraph {
  node [shape=ellipse, fontname=Helvetica, penwidth=2, style=filled, color=lightblue, fillcolor=lightblue, fontcolor=black]
  
 A [label='Data: GEOCON dataset & nighttime data (DMSP-OLS or VIIRS)']
 B [label='Pre-Processing: thresholding illumination (DN values), removing noise']
 C [label='Disaggregation: matching GEOCON and NLs resolution']
...
digraph {
 ...
 A[label='Data: acquisition of geo-coded Demographic and health Surveys from African countries']
 B[label='Pre-Processing: buffering / spatial analysis of data']
 C[label='Data Integration: linking, integration of nighttime lights data from National Oceanic and Atmospheric Administration (DMSP-OLS sensors)']
 D[label='Statistical Analysis']
...
digraph {
  ...
  A[label='Data Acquisition: API, DMSP-OLS, Census, Shapefiles']
  B[label='Pre-Processing: stable lights, centroids']
  C[label='Pre-Processing: stable lights, centroids']
  D[label='Integration: bilinear interpolation, DN values in buffers']
  E[label='Correlation Analysis: Pearson’s r']
  F[label='Regression & Evaluation: multivariate analysis']
...
digraph {
  ...
  A[label='ata Acquisition: annual composites of nighttime light data, Thematic World Borders Dataset for administrative boundaries, socio-economic data (GDP, poverty, population, energy consumption, emissions)']
  B[label='Pre-Processing: thresholding (e.g., area lit, sum of lights, lights index, raw DN values), distinguishing significance']
  C[label='Data Integration: bilinear interpolation, linking NLs data and centroids, calculating DN values in 2, 3, 5 km buffer around centroid']
  D[label='Correlation Analysis: Pearson's R for correlation of NLs and socio-economic variables, regression models to analyse spatial patterns']
  E[label='Interpretation & Application: using NLs as a proxy for socio-economic data, addressing spatial variability in night-time lights']
