...
**Dat*a*: GEOCON dataset & nighttime data DMSP-OLS or better VIIRS
...
# Model Training with Imputation Logics
...
NL data's accuracy is especially dependent on a stable electricity supply since there are difficulties with distinguishing the reason of variation in electricity supply. Also, bare in mind non-electrified villages are not detected ([Dugoua, 2018](https://doi.org/10.1080/01431161.2017.1420936)). 
Obviously, a higher spatial resolutions leads to higher accuracy in capturing variations in NLs ([Bruederle, 2018](https://doi.org/10.1371/journal.pone.0202231)). 
Since NL data isn't a super accurate indicator for a lot of socioeconomic topics it can thus help formulate estimation especially in under-researched areas with poor statistical inventories ([Proville, 2017](https://doi.org/10.1371/journal.pone.0174610)) or difficult data access ([Chen, 2016](https://doi.org/10.1007/978-3-319-22810-5_15)).  Talking about statistical inventories NL data has the strength of detecting possibly informal activities and their spatial patterns, disclosing regional governance differences ([Proville, 2017](https://doi.org/10.1371/journal.pone.0174610)).
Most commonly NL are interpreted as a sign of modernization, urbanization, security, economic development and technological innovation, however it is necessary to regard the downsides of out light emissions. Artificial light pollution is altering species circadian rhythm, as well as the human one. _Artificial light is used in modern societies to extend activity hours  i.e. working hours. Thus, NL could also indicate regional labor protection measurements._ Also it raises costs for astronomical observations due a reduction in night-time sky quality by more "skyglow". 
