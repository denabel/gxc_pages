...
temp_1993 <- terra::rast("./data/C3S_data/era5_temperature1993.grib")
temp_2000 <- terra::rast("./data/C3S_data/era5_temperature2000.grib")
temp_2010 <- terra::rast("./data/C3S_data/era5_temperature2010.grib")
temp_2020 <- terra::rast("./data/C3S_data/era5_temperature2020.grib")
```
...
temp_base <- terra::rast("./data/C3S_data/era5_temperature1961-1990.grib")
...
print(head(world |> arrange(admin)))
```
...
```{r dataset-out}
# head(dataset_out |> arrange(admin))
